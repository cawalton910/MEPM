...
namespace MEPM.Services
{
    public class Email : IEmail
    {
        ...
        public async Task Send(string sendersEmailAddress, string subject, string htmlContext, string sendersname)
        {
           ...
           // PlainTextContext = plainText + " Message from: " + SendersEmailAddress;
            HtmlContent = $"{HtmlContent} Message from: {sendersname}, {SendersEmailAddress}";
            Subject = subject;
